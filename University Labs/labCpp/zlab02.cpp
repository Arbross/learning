//
// Created by student on 28/02/2024.
//
...
void ZLab02::menu() {
    ...
    do {
        cout << "Które zadanie uruchomić?" << endl
             ...
             << "8 -> zadanie 2.9" << endl
             << "9 -> zadanie 2.10" << endl
             << "10 -> zadanie pobierzLiczbe" << endl;
        cin >> wybor;
    } while (wybor < 3 || wybor > 10);

    // Ignoring our 'cin' before the 'getline' function
    // to be sure that our 'pobierzLiczbe' function will be
    // working properly.
    cin.ignore();
    ...
    switch (wybor) {
        ...
        case 9 :
            short min, max;
            cout << "Podaj (short) 'min' parametr: ";
            cin >> min;
            cout << "Podaj (short) 'max' parametr: ";
            cin >> max;
